...
function Explore() {
  ...
  return (
    <div className="min-h-screen bg-[url('https://science.nasa.gov/wp-content/uploads/2023/09/427020main-pia12832-c.jpg?w=1536&format=webp')] bg-cover bg-fixed bg-center text-white">
      {/* Header Section */}
      <Navbar />

      {/* Hero Section */}
      <section className="h-screen flex justify-center items-center flex-col text-center py-20 bg-transparent  bg-opacity-60">
        <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500 mb-4">Explore the Universe of Exoplanets</h1>
        <p className="text-lg">Discover distant worlds, their characteristics, and what makes them unique.</p>
      </section>

      {/* Search and Filter Section */}
      <section className="container mx-auto py-10">
        <h2 className="text-4xl font-semibold text-center text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-yellow-500  mb-10">Discovered Exoplanets</h2>   
